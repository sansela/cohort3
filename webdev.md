...
### Git and Github [🔗]()[🎥](https://app.100xdevs.com/courses/14/475/476)[📝]()

- git init
- git add .
- git status
- git rm --cached fileName
- git commit -m "git demo" -m "commit message"
- git remote -v
- git remote add origin https://github.com/sansela/git-demo-test.git
- git status
- git push
...
- git push origin --delete hot-fix
- git merge main
- PR
  - Fixes #issue-number
  - Closes #issue-number
